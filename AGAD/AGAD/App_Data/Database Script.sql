...
begin
	...
	print 'CITY TABLOSU KURULDU'
end else
	print 'CITY TABLOSU KURULMUÞ'

	if object_id(N'dbo.TOWN', N'U') is null
begin
	...
	print 'TOWN TABLOSU KURULDU'
end else
	print 'TOWN TABLOSU KURULMUÞ'
...
begin
	...
	CONSTRAINT [FK_AGAD_ToTable_2] FOREIGN KEY ([IL]) REFERENCES [dbo].[CITY] ([Id]),
	CONSTRAINT [FK_AGAD_ToTable_3] FOREIGN KEY ([ILCESEMT]) REFERENCES [dbo].[TOWN] ([Id])
	);
